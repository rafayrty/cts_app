...
class PopularNotebooksChart extends ApexChartWidget
{
    /**
     * Chart Id
     */
    protected static string $chartId = 'PopularNotebooksChart';

    /**
     * Widget Title
     */
    protected static ?string $heading = 'Popular Notebooks';
