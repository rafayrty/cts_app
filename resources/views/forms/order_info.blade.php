...
<h1 class="mt-4 text-xl font-bold text-gray-400" style="margin-top:-.5rem;">Order ID# {{$order->order_numeric_id}}</h1>
      <ul class="order-info-list mt-2">
          ...
          <li class="mt-2"><strong>Payment Status: </strong>{{$order->status}}</li>
      </ul>
    <h1 class="mt-4 text-xl font-bold text-gray-400">Customer Info:</h1>
      <ul class="order-info-list mt-4">
          ...
          <li class="mt-2"><strong>Amount Spent:</strong>₪ {{$amount_spent}}</li>
      </ul>
    ...
    <ul class="billing-info-list">
      ...
      @endif
            <li class="mt-2"><strong>Subtotal:</strong>₪ {{$order->sub_total}}</li>
            <li  class="mt-2"><strong>Shipping:</strong>₪ {{$order->shipping}}</li>
            <li  class="mt-2"><strong>Discount Total:</strong>₪ {{$order->discount_total}}</li>
            <li  class="mt-2"><strong>Total:</strong><b class="text-2xl">₪ {{$order->total}}</b></li>
          </ul>
    </div>
</x-dynamic-component>
