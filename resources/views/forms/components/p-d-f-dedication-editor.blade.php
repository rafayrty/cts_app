  ...
  margin-bottom:.5rem;
    ...
    <div x-data="{
        ...
        img_id:'draggable-element-editor-dedication-{{$img_id}}',
           ...
           update_state(){
            this.state = {...this.state,dedication_texts:this.fields}
           },
           ...
           setup_editor(){
            ...
            let self = this;
            interact('.draggable-element-editor-dedication-{{$img_id}}')
                .resizable({
...
<div x-data="{
        ...
        init(){
            if(this.state){
              if(this.state.dedication_texts){
                  if(!this.once){
                  this.state.dedication_texts.forEach((txt)=>{
